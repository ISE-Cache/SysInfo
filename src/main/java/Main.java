public class Main {
    ...
    private static final DataProvider[] dataProviders = {new CPUProvider(), new IpProvider(), new ProcessCountProvider(), new ShellProvider(), new StorageProvider(), new MemoryProvider()};
