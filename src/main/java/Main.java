public class Main {
    public static void main(String[] args) {
        ...
        DataProvider[] dataProviders = new DataProvider[]{new CPUProvider(), new IpProvider(), new ProcessCountProvider(), new ShellProvider(), new StorageProvider(), new MemoryProvider()};
