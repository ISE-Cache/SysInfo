public class Main {
    ...
    private static final DataProvider[] dataProviders = {new CPUProvider(), new MemoryProvider(), new GPUProvider(), new PCIProvider(), new IpProvider(), new ProcessCountProvider(), new ShellProvider(), new StorageProvider()};
